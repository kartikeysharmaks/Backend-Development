...
3. Some knowledge of Node.js and Express.js.

# Step 1 - Installing Mongoose on a Node.js environment

1. Create and navigate to a new folder by running the following commands on a terminal.
$ mkdir mongoose_tutorial
$ cd mongoose_tutorial

2. Then install Express and Mongoose by executing the following command on a terminal.
$ npm install express mongoose --save

3. If you are using Yarn, run:
...
3. Select Connect your application and choose Node.js for the driver.
